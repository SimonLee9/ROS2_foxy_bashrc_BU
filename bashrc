...
alias eb='gedit ~/.bashrc'
alias sb='source ~/.bashrc'
alias rosdinstall='rosdep install -i --from-path src --rosdistro foxy -y -r'
...
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:/home/leecar/dev_ws/src/basic_mobile_robot/models/
source /usr/share/colcon_cd/function/colcon_cd.sh
export _colcon_cd_root=~/dev_ws
